...
<div class="day day--selected col p-2 border border-left-0 border-top-0 text-truncate <%= OffMonthTag %> <%= DayBackgroundTag %>" rel="popover" data-popover-content="#destinationPopover">
