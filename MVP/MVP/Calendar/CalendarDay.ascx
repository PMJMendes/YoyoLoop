...
<div class="day col p-2 border border-left-0 border-top-0 text-truncate <%= DayWeekendTag %> <%= OffMonthTag %> <%= DayBackgroundTag %>" rel="popover" data-popover-content="#destinationPopover">
