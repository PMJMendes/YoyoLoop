<%@ Page Title="Yoyoloop" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="MVP.Test" %>
        ...
        <div class="travel__container">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="travel__copy-bold">Vamos enviar a tua fatura para <span style="color: #ff5f6d;">email@email.com</span></div>
                </div>
                ...
                <div class="row travel__get-tickets pt-5 pb-5">
                    ...
                    <div class="col-md-3 pb-3 d-flex justify-content-center">
                        <a href="/Ticket/Ticket" target="_blank" class="travel__white-btn text-uppercase">download</a>
                    </div>
