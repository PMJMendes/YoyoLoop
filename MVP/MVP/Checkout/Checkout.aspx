                        ...
                        <div class="row next-trip">
                            <div class="col-lg-12 p-0">
                                ...
                                <div class="row time pt-3">
                                    ...
                                    <div class="col-8"><%= pageData.StartTime.ToString("dd MMMM").ToUpper() %>, <%= pageData.StartTime.ToString("dddd").ToUpper() %></div>
                                ...
                                <div class="row time">
                                    <div class="col-8">
                                        ...
                                        <div class="row p-1 price">
                                            ...
                                            <div class="col-8"><strong><%= (pageData.StandardPrice * pageData.Seats).ToString("C") %></strong></div>
                                        </div>
                                ...
                                <div class="row pricing">
                                    ...
                                    <div class="col-8 pr-4 text-right">
                                        <div class="row <%= pageData.PromoValid ? "" : "hide" %>">
                                            <div class="col-12"><s><%= pageData.Seats.ToString() %> <%= pageData.Seats == 1 ? "Lugar" : "Lugares" %><span class="times"> x</span> <span class="price"><%= pageData.StandardPrice.ToString("C") %></span></s></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12"><%= pageData.Seats.ToString() %> <%= pageData.Seats == 1 ? "Lugar" : "Lugares" %><span class="times"> x</span> <span class="price"><%= pageData.Price.ToString("C") %></span></div>
                                        </div>
                                        <div class="row <%= pageData.PromoValid ? "" : "hide" %>">
                                            <div class="col-12 total-price"><s><%= (pageData.StandardPrice * pageData.Seats).ToString("C") %></s></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12 total-price"><%= (pageData.Price * pageData.Seats).ToString("C") %></div>
                                        </div>
                                    </div>
                                </div>
