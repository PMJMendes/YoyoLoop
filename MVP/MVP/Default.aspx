          ...
          <div class="row row-no-padding mt-3 mb-5">
            <div class="col-md-6 col-lg-3 pl-0">
              <div class="homepage__where-to-card homepage__where-to-card--lisboa mb-2 d-flex flex-column align-items-center">
                ...
                <a OnClick="javascript:$.blockUI({ message: $('#divBlockUI'), baseZ: 20000 })" href="/Calendar/Calendar?Dest=Lisboa" class="homepage__where-to-card__reserve mb-5 d-flex align-items-center justify-content-center">Reservar</a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pl-0">
              <div class="homepage__where-to-card homepage__where-to-card--leiria mb-2 d-flex flex-column align-items-center">
                ...
                <div class="homepage__where-to-card__when mb-4">Todos os dias</div>
                <a OnClick="javascript:$.blockUI({ message: $('#divBlockUI'), baseZ: 20000 })" href="/Calendar/Calendar?Dest=Leiria" class="homepage__where-to-card__reserve mb-5 d-flex align-items-center justify-content-center">Reservar</a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pl-0">
              <div class="homepage__where-to-card homepage__where-to-card--coimbra mb-2 d-flex flex-column align-items-center">
                ...
                <div class="homepage__where-to-card__from mb-2">De Lisboa</div>
                <div class="homepage__where-to-card__when mb-4">Todos os dias</div>
                <a OnClick="javascript:$.blockUI({ message: $('#divBlockUI'), baseZ: 20000 })" href="/Calendar/Calendar?Dest=Coimbra" class="homepage__where-to-card__reserve mb-5 d-flex align-items-center justify-content-center">Reservar</a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pl-0">
              <div class="homepage__where-to-card homepage__where-to-card--cascais mb-2 d-flex flex-column align-items-center">
                ...
                <div class="homepage__where-to-card__from mb-2">De Lisboa</div>
                <div class="homepage__where-to-card__when mb-4">Todos os dias</div>
                <a OnClick="javascript:$.blockUI({ message: $('#divBlockUI'), baseZ: 20000 })" href="/Calendar/Calendar?Dest=Linha%20de%20Cascais" class="homepage__where-to-card__reserve mb-5 d-flex align-items-center justify-content-center">Reservar</a>
              </div>
            </div>
          </div>
        </div>
