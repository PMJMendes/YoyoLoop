...
<div class="row travel__card">
    ...
    <div class="col-md-4 pl-0 travel__card__last text-right">
            ...
            <div class="row text-center">
                <div class="col-12">
                    <div class="travel__card-past--cancelled text-uppercase d-flex align-items-center justify-content-center">
                        <asp:Literal runat="server" Text="<%$ Resources:LocalizedText, Controls_Ticket_Pending%>"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <p class="travel__card__last__gray-text mb-0"><asp:Literal runat="server" Text="<%$ Resources:LocalizedText, Controls_Ticket_Total%>"/></p>
        <p class="travel__card__last__price"><%= TicketBooking.Cost.ToString("C", ApplicationHelpers.DefaultCulture()) %></p>
            ...
            <div class="row text-center">
                <div class="col-12">
                    <a OnClick="javascript:$.blockUI()" href="/Confirm/Confirm?Id=<%= TicketBooking.BookingId.ToString() %>" class="travel__card--details btn btn-primary text-uppercase">
                        <asp:Literal runat="server" Text="<%$ Resources:LocalizedText, Controls_Ticket_btnViewBooking_Text%>"/>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row text-center">
                <div class="col-12">
                    <a OnClick="javascript:$.blockUI()" href="/Checkout/Checkout?Id=<%= TicketBooking.BookingId.ToString() %>" class="travel__card--details btn btn-primary text-uppercase">
                        <asp:Literal runat="server" Text="<%$ Resources:LocalizedText, Controls_Ticket_btnBooking_Text%>"/>
                    </a>
                </div>
            </div>
        </div>
