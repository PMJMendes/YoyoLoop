...
namespace MVP.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<MVP.Models.EntityModel>
    {
        ...
        protected override void Seed(MVP.Models.EntityModel context)
        {
            ...
            context.Route.Add(new Route() { RouteId = Guid.NewGuid(), Name = "Lisboa-Leiria", StartRegion = lr1, EndRegion = lr2, Duration = new TimeSpan(1, 30, 0), MinStartTime = new TimeSpan(8, 0, 0), MaxEndTime = new TimeSpan(17, 30, 0) });
            context.Route.Add(new Route() { RouteId = Guid.NewGuid(), Name = "Leiria-Lisboa", StartRegion = lr2, EndRegion = lr1, Duration = new TimeSpan(1, 30, 0), MinStartTime = new TimeSpan(9, 30, 0), MaxEndTime = new TimeSpan(19, 0, 0) });
