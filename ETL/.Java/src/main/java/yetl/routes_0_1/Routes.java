        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.Activo = dis.readBoolean();
						...
						this.Duracao = (Object) dis.readObject();
...
int count_tPostgresqlOutput_3=0;
	    String insert_tPostgresqlOutput_3 = "INSERT INTO \"" + tableName_tPostgresqlOutput_3 + "\" (\"RouteId\",\"StartRegion_LoopedRegionId\",\"EndRegion_LoopedRegionId\",\"Active\",\"Duration\") VALUES (?,?,?,?,?)";
...
creates_tmp.Activo = false;
creates_tmp.Duracao = new org.postgresql.util.PGInterval ("00:00:00");
creates = creates_tmp;
...
} else {pstmt_tPostgresqlOutput_3.setObject(2, creates.StartRegion_LoopedRegionId);
}

                    if(creates.EndRegion_LoopedRegionId == null) {
pstmt_tPostgresqlOutput_3.setNull(3, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(3, creates.EndRegion_LoopedRegionId);
}

                    pstmt_tPostgresqlOutput_3.setBoolean(4, creates.Activo);

                    if(creates.Duracao == null) {
pstmt_tPostgresqlOutput_3.setNull(5, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(5, creates.Duracao);
}
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        if(emptyColumnCount_tFileInputExcel_2 >= 3){
        	break; //if meet the empty row, there will break the iterate.
        }
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Routes.class.getClassLoader().getResourceAsStream("yetl/routes_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     211554 characters generated by Talend Open Studio for Data Integration 
 *     on the 20 de Setembro de 2018 15:45:14 BST
 ************************************************************************************************/