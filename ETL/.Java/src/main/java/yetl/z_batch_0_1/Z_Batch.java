...
/**
 * Job: Z_Batch Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.3.0.20161026_1219
 * @status 
 */
public class Z_Batch implements TalendJob {
	...
	private final String jobName = "Z_Batch";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Z_Batch.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final Z_Batch Z_BatchClass = new Z_Batch();

		int exitCode = Z_BatchClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Z_Batch.class.getClassLoader()
					.getResourceAsStream(
							"yetl/z_batch_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Z_Batch");
		}
...
/************************************************************************************************
 * 30663 characters generated by Talend Open Studio for Data Integration on the
 * 8 de Setembro de 2018 19:27:36 BST
 ************************************************************************************************/
