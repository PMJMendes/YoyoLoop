...
package yetl.mock_job_for_guess_schema_0_1;
	...
	public void tLibraryLoad_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class BytesLimit65535_tLibraryLoad_2 {
					public void limitLog4jByte() throws Exception {

					}
				}

				new BytesLimit65535_tLibraryLoad_2().limitLog4jByte();
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url = "jdbc:postgresql://localhost:5432/yolo-mvp";
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select \"public\".\"AccessPoints\".\"AccessPointId\",\"public\".\"AccessPoints\".\"Active\",  \"public\".\"AccessPoints\".\"Default\",\"public\".\"AccessPoints\".\"GoogleLocation\",  \"public\".\"AccessPoints\".\"Name\",\"public\".\"AccessPoints\".\"Region_LoopedRegionId\"  from \"public\".\"AccessPoints\"");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/Program Files/Talend/TOS_DI-20161026_1219-V6.3.0/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"yetl/mock_job_for_guess_schema_0_1/contexts/"
...
/************************************************************************************************
 * 29942 characters generated by Talend Open Studio for Data Integration on the
 * 8 de Setembro de 2018 19:15:41 BST
 ************************************************************************************************/
