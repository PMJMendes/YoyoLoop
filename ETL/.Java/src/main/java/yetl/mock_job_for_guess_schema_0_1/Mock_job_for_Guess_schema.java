		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select \"public\".\"Promocodes\".\"Code\",\"public\".\"Promocodes\".\"PromocodeId\"  from \"public\".\"Promocodes\"");
...
/************************************************************************************************
 * 29750 characters generated by Talend Open Studio for Data Integration on the
 * 13 de Setembro de 2018 23:01:51 BST
 ************************************************************************************************/
