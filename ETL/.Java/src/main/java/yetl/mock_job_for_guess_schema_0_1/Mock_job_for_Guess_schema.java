		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select \"public\".\"Fares\".\"Route_RouteId\" from \"public\".\"Fares\"  where \"public\".\"Fares\".\"Price\" > 0");
...
/************************************************************************************************
 * 29748 characters generated by Talend Open Studio for Data Integration on the
 * 13 de Setembro de 2018 0:04:04 BST
 ************************************************************************************************/
