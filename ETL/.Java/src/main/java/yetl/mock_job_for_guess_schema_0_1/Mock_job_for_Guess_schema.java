		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select \"public\".\"Routes\".\"EndRegion_LoopedRegionId\",\"public\".\"Routes\".\"RouteId\",  \"public\".\"Routes\".\"StartRegion_LoopedRegionId\",   \"public\".\"Routes\".\"Duration\"  from \"public\".\"Routes\"");
...
/************************************************************************************************
 * 33314 characters generated by Talend Open Studio for Data Integration on the
 * 22 de Dezembro de 2018 18:20:03 GMT
 ************************************************************************************************/
