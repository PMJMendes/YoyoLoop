		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select \"public\".\"Routes\".\"EndRegion_LoopedRegionId\",\"public\".\"Routes\".\"RouteId\",  \"public\".\"Routes\".\"StartRegion_LoopedRegionId\"  from \"public\".\"Routes\"");
...
/************************************************************************************************
 * 29809 characters generated by Talend Open Studio for Data Integration on the
 * 9 de Setembro de 2018 18:40:20 BST
 ************************************************************************************************/
