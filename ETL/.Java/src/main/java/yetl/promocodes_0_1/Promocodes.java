...
int count_tPostgresqlOutput_1=0;
	    String update_tPostgresqlOutput_1 = "UPDATE \"" + tableName_tPostgresqlOutput_1 + "\" SET \"Active\" = ? WHERE \"PromocodeId\" = ?";
...
int count_tPostgresqlOutput_2=0;
	    String insert_tPostgresqlOutput_2 = "INSERT INTO \"" + tableName_tPostgresqlOutput_2 + "\" (\"Code\",\"StartDate\",\"EndDate\",\"PromocodeId\",\"Active\") VALUES (?,?,?,?,?)";
...
} else {pstmt_tPostgresqlOutput_1.setObject(2 + count_tPostgresqlOutput_1, updates.PromocodeId);
}
...
} else {pstmt_tPostgresqlOutput_2.setObject(4, creates.PromocodeId);
}

                    pstmt_tPostgresqlOutput_2.setBoolean(5, creates.Activo);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Promocodes.class.getClassLoader().getResourceAsStream("yetl/promocodes_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     117634 characters generated by Talend Open Studio for Data Integration 
