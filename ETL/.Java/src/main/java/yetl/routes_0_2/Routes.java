...
} else {pstmt_tPostgresqlOutput_2.setObject(1, creates.StartRegion_LoopedRegionId);
}

                    if(creates.EndRegion_LoopedRegionId == null) {
pstmt_tPostgresqlOutput_2.setNull(2, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(2, creates.EndRegion_LoopedRegionId);
}
...
} else {pstmt_tPostgresqlOutput_2.setObject(4, creates.RouteId);
}
...
/************************************************************************************************
 *     235086 characters generated by Talend Open Studio for Data Integration 
 *     on the 22 de Dezembro de 2018 18:59:44 GMT
 ************************************************************************************************/