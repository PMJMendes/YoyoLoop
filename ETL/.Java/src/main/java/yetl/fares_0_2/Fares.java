...
} else {pstmt_tPostgresqlOutput_3.setObject(1, creates.RouteId);
}
...
} else {pstmt_tPostgresqlOutput_3.setObject(4, creates.FareId);
}
...
} else {pstmt_tPostgresqlOutput_5.setObject(1, copyOfcreates.RouteId);
}
...
} else {pstmt_tPostgresqlOutput_5.setObject(4, copyOfcreates.FareId);
}
...
public void tPostgresqlCommit_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tPostgresqlCommit_1";
    	...
    	class BytesLimit65535_tPostgresqlCommit_1{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tPostgresqlCommit_1().limitLog4jByte();
...
/************************************************************************************************
 *     304880 characters generated by Talend Open Studio for Data Integration 
 *     on the 22 de Dezembro de 2018 20:43:00 GMT
 ************************************************************************************************/