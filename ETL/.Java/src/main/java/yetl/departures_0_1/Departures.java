...
int count_tPostgresqlOutput_2=0;
	    String update_tPostgresqlOutput_2 = "UPDATE \"" + tableName_tPostgresqlOutput_2 + "\" SET \"Active\" = ? WHERE \"DepartureId\" = ?";
...
int count_tPostgresqlOutput_3=0;
	    String insert_tPostgresqlOutput_3 = "INSERT INTO \"" + tableName_tPostgresqlOutput_3 + "\" (\"Route_RouteId\",\"DayType\",\"Time\",\"Active\",\"DepartureId\") VALUES (?,?,?,?,?)";
...
} else {pstmt_tPostgresqlOutput_2.setObject(2 + count_tPostgresqlOutput_2, updates.DepartureId);
}
...
pstmt_tPostgresqlOutput_3.setNull(3, java.sql.Types.OTHER);
                    ...
                    pstmt_tPostgresqlOutput_3.setBoolean(4, creates.Activo);

                    if(creates.DepartureId == null) {
pstmt_tPostgresqlOutput_3.setNull(5, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(5, creates.DepartureId);
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Departures.class.getClassLoader().getResourceAsStream("yetl/departures_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     202653 characters generated by Talend Open Studio for Data Integration 
