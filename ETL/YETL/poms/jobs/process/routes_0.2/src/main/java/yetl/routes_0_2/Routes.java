...
/**
 * Job: Routes Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Routes implements TalendJob {
...
public String getServer(){
	...
	private final String jobName = "Routes";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Routes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.Active = dis.readBoolean();
						...
						this.Duration = (Object) dis.readObject();
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_YETL_Routes.length) {
				if(length < 1024 && commonByteArray_YETL_Routes.length == 0) {
   					commonByteArray_YETL_Routes = new byte[1024];
				} else {
   					commonByteArray_YETL_Routes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_YETL_Routes, 0, length);
			strReturn = new String(commonByteArray_YETL_Routes, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.Origem == null) ? 0 : this.Origem.hashCode());
    ...
    public int compareTo(out1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.Origem, other.Origem);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.Destino, other.Destino);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tPostgresqlOutput_3 == null || dbschema_tPostgresqlOutput_3.trim().length() == 0) {
	tableName_tPostgresqlOutput_3 = "Routes";
} else {
	tableName_tPostgresqlOutput_3 = dbschema_tPostgresqlOutput_3 + "\".\"" + "Routes";
}
...
int count_tPostgresqlOutput_3=0;
	    String update_tPostgresqlOutput_3 = "UPDATE \"" + tableName_tPostgresqlOutput_3 + "\" SET \"Active\" = ?,\"Duration\" = ? WHERE \"RouteId\" = ?";
...
int count_tPostgresqlOutput_2=0;
	    String insert_tPostgresqlOutput_2 = "INSERT INTO \"" + tableName_tPostgresqlOutput_2 + "\" (\"StartRegion_LoopedRegionId\",\"EndRegion_LoopedRegionId\",\"Duration\",\"RouteId\",\"Active\") VALUES (?,?,?,?,?)";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Origem = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Origem = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Destino = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Destino = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Duracao = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Duracao = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Ignore";

				row1.Ignore = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Ignore = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row1 != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
            ope_tFilterRow_1.matches((row1.Origem == null? false : row1.Origem.compareTo("") != 0)
                           , "Origem.compareTo(\"\") != 0 failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row3 == null){ 
                row3 = new row3Struct();
              }
               row3.Origem = row1.Origem;
               row3.Destino = row1.Destino;
               row3.Duracao = row1.Duracao;
               row3.Ignore = row1.Ignore;    
...
// # Output table : 'out1'
out1_tmp.Origem = row3.Destino ;
out1_tmp.Destino = row3.Origem ;
out1_tmp.Duracao = row3.Duracao ;
out1_tmp.Ignore = row3.Ignore ;
out1 = out1_tmp;
// ###############################
...
// for output
			...
			row5.Origem = out1.Origem;								
			row5.Destino = out1.Destino;								
			row5.Duracao = out1.Duracao;								
			row5.Ignore = out1.Ignore;			
...
// # Output table : 'out2'
out2_tmp.StartRegion_LoopedRegionId = row6.LoopedRegionId ;
out2_tmp.EndRegion_LoopedRegionId = row7.LoopedRegionId ;
out2_tmp.Duracao = row5.Duracao ;
out2 = out2_tmp;
 					    ...
 					    boolean forceLooprow9 = false;
 							...
 							row9Struct row9ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		...
                        		    		row9HashKey.EndRegion_LoopedRegionId = out2.EndRegion_LoopedRegionId ;
                        		    		
                        		    		row9HashKey.StartRegion_LoopedRegionId = out2.StartRegion_LoopedRegionId ;
								  ...
								  if(!tHash_Lookup_row9.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row9 != null && tHash_Lookup_row9.getCount(row9HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row9' and it contains more one result from keys :  row9.EndRegion_LoopedRegionId = '" + row9HashKey.EndRegion_LoopedRegionId + "', row9.StartRegion_LoopedRegionId = '" + row9HashKey.StartRegion_LoopedRegionId + "'");
								} // G 071
...
updates_tmp.Active = true;
updates_tmp.Duration = new org.postgresql.util.PGInterval ("" + out2.Duracao + " minutes");
updates = updates_tmp;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_3 ) {
creates_tmp.StartRegion_LoopedRegionId = out2.StartRegion_LoopedRegionId ;
creates_tmp.EndRegion_LoopedRegionId = out2.EndRegion_LoopedRegionId ;
creates_tmp.Duration = new org.postgresql.util.PGInterval ("" + out2.Duracao + " minutes");
creates_tmp.RouteId = java.util.UUID.randomUUID();
creates_tmp.Active = true;
creates = creates_tmp;
...
if(updates != null) { 
	...
	currentComponent="tPostgresqlOutput_3";
        ...
        whetherReject_tPostgresqlOutput_3 = false;
                    pstmt_tPostgresqlOutput_3.setBoolean(1, updates.Active);

                    if(updates.Duration == null) {
pstmt_tPostgresqlOutput_3.setNull(2, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(2, updates.Duration);
}

                    if(updates.RouteId == null) {
pstmt_tPostgresqlOutput_3.setNull(3 + count_tPostgresqlOutput_3, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(3 + count_tPostgresqlOutput_3, updates.RouteId);
}
...
if(creates != null) { 
	...
	currentComponent="tPostgresqlOutput_2";
        ...
        whetherReject_tPostgresqlOutput_2 = false;
                    if(creates.StartRegion_LoopedRegionId == null) {
pstmt_tPostgresqlOutput_2.setNull(1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(1, creates.StartRegion_LoopedRegionId, java.sql.Types.OTHER);
}

                    if(creates.EndRegion_LoopedRegionId == null) {
pstmt_tPostgresqlOutput_2.setNull(2, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(2, creates.EndRegion_LoopedRegionId, java.sql.Types.OTHER);
}

                    if(creates.Duration == null) {
pstmt_tPostgresqlOutput_2.setNull(3, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(3, creates.Duration);
}

                    if(creates.RouteId == null) {
pstmt_tPostgresqlOutput_2.setNull(4, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(4, creates.RouteId, java.sql.Types.OTHER);
}

                    pstmt_tPostgresqlOutput_2.setBoolean(5, creates.Active);
 ...
 */
	...
	currentComponent="tFileInputExcel_2";
        ...
        sheetList_tFileInputExcel_2.addAll(regexUtil_tFileInputExcel_2.getSheets(workbook_tFileInputExcel_2, "Precos", false));
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "Origem";

				row2.Origem = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Origem = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Destino";

				row2.Destino = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Destino = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Duracao";

				row2.Duracao = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null, '.'==decimalChar_tFileInputExcel_2 ? null : decimalChar_tFileInputExcel_2));
			}else{
				row2.Duracao = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Ignore";

				row2.Ignore = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Ignore = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
if(row2 != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
            ope_tFilterRow_2.matches((row2.Origem == null? false : row2.Origem.compareTo("") != 0)
                           , "Origem.compareTo(\"\") != 0 failed");
    ...
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(row4 == null){ 
               ...
               row4.Origem = row2.Origem;
               row4.Destino = row2.Destino;
               row4.Duracao = row2.Duracao;
               row4.Ignore = row2.Ignore;    
...
// for output
			...
			row5.Origem = row4.Origem;								
			row5.Destino = row4.Destino;								
			row5.Duracao = row4.Duracao;								
			row5.Ignore = row4.Ignore;			
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tPostgresqlInput_1 - inputs:(after_tFileInputExcel_1) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_2 - inputs:(row5,row6,row7) outputs:(out2)
...
+"dRegions\" where \"public\".\"LoopedRegions\".\"Active\" = true\n;";
            ...
            if(rs_tPostgresqlInput_1.getObject(1) != null) {
                row6.LoopedRegionId = rs_tPostgresqlInput_1.getObject(1);
            } else {
        	...
        	row6.Name = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 2, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// source node:tPostgresqlInput_2 - inputs:(after_tFileInputExcel_1) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
			   		// linked node: tMap_2 - inputs:(row5,row6,row7) outputs:(out2)
...
+"dRegions\" where \"public\".\"LoopedRegions\".\"Active\" = true\n;";
		    ...
		    while (rs_tPostgresqlInput_2.next()) {
		        nb_line_tPostgresqlInput_2++;
							...
							if(colQtyInRs_tPostgresqlInput_2 < 1) {
								row7.LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(1) != null) {
                row7.LoopedRegionId = rs_tPostgresqlInput_2.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row7.Name = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
			...
			//row7
				...
				row7_HashRow.LoopedRegionId = row7.LoopedRegionId;
...
+"tartRegion_LoopedRegionId\" \nfrom \"public\".\"Routes\"";
		    ...
		    while (rs_tPostgresqlInput_4.next()) {
		        nb_line_tPostgresqlInput_4++;
							...
							if(colQtyInRs_tPostgresqlInput_4 < 1) {
								row9.EndRegion_LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_4.getObject(1) != null) {
                row9.EndRegion_LoopedRegionId = rs_tPostgresqlInput_4.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_4.getObject(2) != null) {
                row9.RouteId = rs_tPostgresqlInput_4.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_4 < 3) {
								row9.StartRegion_LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_4.getObject(3) != null) {
                row9.StartRegion_LoopedRegionId = rs_tPostgresqlInput_4.getObject(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row9";
			...
			//row9
				...
				row9_HashRow.EndRegion_LoopedRegionId = row9.EndRegion_LoopedRegionId;
				
				row9_HashRow.RouteId = row9.RouteId;
				
				row9_HashRow.StartRegion_LoopedRegionId = row9.StartRegion_LoopedRegionId;
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "Routes";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "Routes";
}
...
int count_tPostgresqlOutput_1=0;
	    String update_tPostgresqlOutput_1 = "UPDATE \"" + tableName_tPostgresqlOutput_1 + "\" SET \"" + "Active" + "\" = " + "False" + " WHERE \"RouteId\" = ?";
 ...
 */
	...
	currentComponent="tPostgresqlInput_3";
		...
		int tos_count_tPostgresqlInput_3 = 0;
		    ...
		    String dbquery_tPostgresqlInput_3 = "select \"public\".\"Routes\".\"RouteId\" \nfrom \"public\".\"Routes\"";
            ...
            if(rs_tPostgresqlInput_3.getObject(1) != null) {
                row8.RouteId = rs_tPostgresqlInput_3.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tPostgresqlOutput_1";
        ...
        whetherReject_tPostgresqlOutput_1 = false;
                    if(row8.RouteId == null) {
pstmt_tPostgresqlOutput_1.setNull(1 + count_tPostgresqlOutput_1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_1.setObject(1 + count_tPostgresqlOutput_1, row8.RouteId);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Routes RoutesClass = new Routes();

        int exitCode = RoutesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Routes.class.getClassLoader().getResourceAsStream("yetl/routes_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Routes.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Routes");
        }
...
/************************************************************************************************
 *     251782 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 de Janeiro de 2019 20:08:54 GMT
 ************************************************************************************************/