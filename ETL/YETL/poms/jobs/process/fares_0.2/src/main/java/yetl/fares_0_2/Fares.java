...
/**
 * Job: Fares Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Fares implements TalendJob {
...
public String getServer(){
	...
	private final String jobName = "Fares";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Fares.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_YETL_Fares = new byte[0];
    static byte[] commonByteArray_YETL_Fares = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.FareId == null) ? 0 : this.FareId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						} else if (!this.FareId.equals(other.FareId))
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_YETL_Fares) {

        	try {

        		int length = 0;
		
						this.FareId = (Object) dis.readObject();
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("FareId="+String.valueOf(FareId));
	    sb.append("]");
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.FareId, other.FareId);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "Fares";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "Fares";
}
...
int count_tPostgresqlOutput_1=0;
	    String update_tPostgresqlOutput_1 = "UPDATE \"" + tableName_tPostgresqlOutput_1 + "\" SET \"" + "Price" + "\" = " + "0.0" + " WHERE \"FareId\" = ?";
 ...
 */
	...
	currentComponent="tPostgresqlInput_1";
		...
		int tos_count_tPostgresqlInput_1 = 0;
		    ...
		    String dbquery_tPostgresqlInput_1 = "select \"public\".\"Fares\".\"FareId\" \nfrom \"public\".\"Fares\"";
            ...
            if(rs_tPostgresqlInput_1.getObject(1) != null) {
                row1.FareId = rs_tPostgresqlInput_1.getObject(1);
            } else {
 ...
 */
	...
	currentComponent="tPostgresqlOutput_1";
        ...
        whetherReject_tPostgresqlOutput_1 = false;
                    if(row1.FareId == null) {
pstmt_tPostgresqlOutput_1.setNull(1 + count_tPostgresqlOutput_1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_1.setObject(1 + count_tPostgresqlOutput_1, row1.FareId);
}
...
public static class copyOfupdatesStruct implements routines.system.IPersistableRow<copyOfupdatesStruct> {
    final static byte[] commonByteArrayLock_YETL_Fares = new byte[0];
    static byte[] commonByteArray_YETL_Fares = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final copyOfupdatesStruct other = (copyOfupdatesStruct) obj;
	...
	public void copyDataTo(copyOfupdatesStruct other) {
	...
	public void copyKeysDataTo(copyOfupdatesStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(copyOfupdatesStruct other) {
...
public static class copyOfcreatesStruct implements routines.system.IPersistableRow<copyOfcreatesStruct> {
    final static byte[] commonByteArrayLock_YETL_Fares = new byte[0];
    static byte[] commonByteArray_YETL_Fares = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final copyOfcreatesStruct other = (copyOfcreatesStruct) obj;
	...
	public void copyDataTo(copyOfcreatesStruct other) {
	...
	public void copyKeysDataTo(copyOfcreatesStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(copyOfcreatesStruct other) {
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
    ...
    static byte[] commonByteArray_YETL_Fares = new byte[0];
			    ...
			    public Object StartRegion_LoopedRegionId;

				public Object getStartRegion_LoopedRegionId () {
					return this.StartRegion_LoopedRegionId;
				}
				
			    public Object EndRegion_LoopedRegionId;

				public Object getEndRegion_LoopedRegionId () {
					return this.EndRegion_LoopedRegionId;
				}
		...
		synchronized(commonByteArrayLock_YETL_Fares) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.StartRegion_LoopedRegionId = (Object) dis.readObject();
					
						this.EndRegion_LoopedRegionId = (Object) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Object
       			    	...
       			    	dos.writeObject(this.StartRegion_LoopedRegionId);
					
					// Object
				
       			    	dos.writeObject(this.EndRegion_LoopedRegionId);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("StartRegion_LoopedRegionId="+String.valueOf(StartRegion_LoopedRegionId));
		sb.append(",EndRegion_LoopedRegionId="+String.valueOf(EndRegion_LoopedRegionId));
		sb.append(",Codigo="+String.valueOf(Codigo));
		sb.append(",Preco="+String.valueOf(Preco));
	    sb.append("]");
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.StartRegion_LoopedRegionId == null) ? 0 : this.StartRegion_LoopedRegionId.hashCode());
					
						result = prime * result + ((this.EndRegion_LoopedRegionId == null) ? 0 : this.EndRegion_LoopedRegionId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final out2Struct other = (out2Struct) obj;
						...
						if (this.StartRegion_LoopedRegionId == null) {
							if (other.StartRegion_LoopedRegionId != null)
								return false;
						
						} else if (!this.StartRegion_LoopedRegionId.equals(other.StartRegion_LoopedRegionId))
						
							return false;
					
						if (this.EndRegion_LoopedRegionId == null) {
							if (other.EndRegion_LoopedRegionId != null)
								return false;
						
						} else if (!this.EndRegion_LoopedRegionId.equals(other.EndRegion_LoopedRegionId))
	...
	public void copyDataTo(out2Struct other) {
		...
		other.StartRegion_LoopedRegionId = this.StartRegion_LoopedRegionId;
	            other.EndRegion_LoopedRegionId = this.EndRegion_LoopedRegionId;
	            other.Codigo = this.Codigo;
	            other.Preco = this.Preco;
    ...
    public int compareTo(out2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.StartRegion_LoopedRegionId, other.StartRegion_LoopedRegionId);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.EndRegion_LoopedRegionId, other.EndRegion_LoopedRegionId);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_YETL_Fares.length) {
				if(length < 1024 && commonByteArray_YETL_Fares.length == 0) {
   					commonByteArray_YETL_Fares = new byte[1024];
				} else {
   					commonByteArray_YETL_Fares = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_YETL_Fares, 0, length);
			strReturn = new String(commonByteArray_YETL_Fares, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String toString() {
		...
		sb.append("Origem="+Origem);
		sb.append(",Destino="+Destino);
		sb.append(",Duracao="+String.valueOf(Duracao));
		sb.append(",Tarifa="+Tarifa);
		sb.append(",Codigo="+String.valueOf(Codigo));
		sb.append(",Preco="+String.valueOf(Preco));
	    sb.append("]");
...
copyOfupdatesStruct copyOfupdates = new copyOfupdatesStruct();
copyOfcreatesStruct copyOfcreates = new copyOfcreatesStruct();
...
if(dbschema_tPostgresqlOutput_2 == null || dbschema_tPostgresqlOutput_2.trim().length() == 0) {
	tableName_tPostgresqlOutput_2 = "Fares";
} else {
	tableName_tPostgresqlOutput_2 = dbschema_tPostgresqlOutput_2 + "\".\"" + "Fares";
}
...
int count_tPostgresqlOutput_2=0;
	    String update_tPostgresqlOutput_2 = "UPDATE \"" + tableName_tPostgresqlOutput_2 + "\" SET \"Price\" = ? WHERE \"FareId\" = ?";
...
if(dbschema_tPostgresqlOutput_3 == null || dbschema_tPostgresqlOutput_3.trim().length() == 0) {
	tableName_tPostgresqlOutput_3 = "Fares";
} else {
	tableName_tPostgresqlOutput_3 = dbschema_tPostgresqlOutput_3 + "\".\"" + "Fares";
}
...
int count_tPostgresqlOutput_3=0;
	    String insert_tPostgresqlOutput_3 = "INSERT INTO \"" + tableName_tPostgresqlOutput_3 + "\" (\"Route_RouteId\",\"Type\",\"Price\",\"FareId\") VALUES (?,?,?,?)";
	...
	currentComponent="tPostgresqlOutput_4";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("copyOfupdates" + iterateId, 0, 0);
...
String dbschema_tPostgresqlOutput_4 = null;
	dbschema_tPostgresqlOutput_4 = (String)globalMap.get("schema_" + "tPostgresqlConnection_1");
	

String tableName_tPostgresqlOutput_4 = null;
if(dbschema_tPostgresqlOutput_4 == null || dbschema_tPostgresqlOutput_4.trim().length() == 0) {
	tableName_tPostgresqlOutput_4 = "Fares";
} else {
	tableName_tPostgresqlOutput_4 = dbschema_tPostgresqlOutput_4 + "\".\"" + "Fares";
}
...
String dbUser_tPostgresqlOutput_4 = null;
	...
	conn_tPostgresqlOutput_4 = (java.sql.Connection)globalMap.get("conn_tPostgresqlConnection_1");
...
int count_tPostgresqlOutput_4=0;
	    String update_tPostgresqlOutput_4 = "UPDATE \"" + tableName_tPostgresqlOutput_4 + "\" SET \"Price\" = ? WHERE \"FareId\" = ?";
	    java.sql.PreparedStatement pstmt_tPostgresqlOutput_4 = conn_tPostgresqlOutput_4.prepareStatement(update_tPostgresqlOutput_4);
	...
	currentComponent="tPostgresqlOutput_5";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("copyOfcreates" + iterateId, 0, 0);
...
String dbschema_tPostgresqlOutput_5 = null;
	dbschema_tPostgresqlOutput_5 = (String)globalMap.get("schema_" + "tPostgresqlConnection_1");
	

String tableName_tPostgresqlOutput_5 = null;
if(dbschema_tPostgresqlOutput_5 == null || dbschema_tPostgresqlOutput_5.trim().length() == 0) {
	tableName_tPostgresqlOutput_5 = "Fares";
} else {
	tableName_tPostgresqlOutput_5 = dbschema_tPostgresqlOutput_5 + "\".\"" + "Fares";
}
...
String dbUser_tPostgresqlOutput_5 = null;
	...
	conn_tPostgresqlOutput_5 = (java.sql.Connection)globalMap.get("conn_tPostgresqlConnection_1");
...
int count_tPostgresqlOutput_5=0;
	    String insert_tPostgresqlOutput_5 = "INSERT INTO \"" + tableName_tPostgresqlOutput_5 + "\" (\"Route_RouteId\",\"Type\",\"Price\",\"FareId\") VALUES (?,?,?,?)";
...
// ###############################
// # Outputs initialization
copyOfupdatesStruct copyOfupdates_tmp = new copyOfupdatesStruct();
copyOfcreatesStruct copyOfcreates_tmp = new copyOfcreatesStruct();
// ###############################
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Precos", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        Integer lastColumn_tFileInputExcel_1 = 6;
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "Origem";

				row2.Origem = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Origem = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Destino";

				row2.Destino = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Destino = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Duracao";

				row2.Duracao = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Duracao = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Tarifa";

				row2.Tarifa = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Tarifa = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Codigo";

				row2.Codigo = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Codigo = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Preco";

				row2.Preco = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Preco = null;
				emptyColumnCount_tFileInputExcel_1++;
			}

        if(emptyColumnCount_tFileInputExcel_1 >= 6){
...
if(row2 != null) { 
    ...
    if ( row2.Origem != null ) {
    globalMap.put("ORIGEM", row2.Origem);
    row3.Origem = row2.Origem;
}
else {
    row3.Origem = (String)globalMap.get("ORIGEM");
}

if ( row2.Destino != null ) {
    globalMap.put("DESTINO", row2.Destino);
    row3.Destino = row2.Destino;
}
else {
    row3.Destino = (String)globalMap.get("DESTINO");
}

row3.Tarifa = row2.Tarifa;
row3.Codigo = row2.Codigo;
row3.Preco = row2.Preco;
 ...
 */
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
            ope_tFilterRow_1.matches((row3.Tarifa == null? false : row3.Tarifa.compareTo("") != 0)
                           , "Tarifa.compareTo(\"\") != 0 failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row4 == null){ 
                row4 = new row4Struct();
              }
               row4.Origem = row3.Origem;
               row4.Destino = row3.Destino;
               row4.Tarifa = row3.Tarifa;
               row4.Codigo = row3.Codigo;
               row4.Preco = row3.Preco;    
...
// # Output table : 'out2'
out2_tmp.StartRegion_LoopedRegionId = row5.LoopedRegionId ;
out2_tmp.EndRegion_LoopedRegionId = row6.LoopedRegionId ;
out2_tmp.Codigo = row4.Codigo ;
out2_tmp.Preco = row4.Preco ;
out2 = out2_tmp;
...
if(out2 != null) { 
	...
	row9.StartRegion_LoopedRegionId = out2.StartRegion_LoopedRegionId;								
	row9.EndRegion_LoopedRegionId = out2.EndRegion_LoopedRegionId;								
	row9.Codigo = out2.Codigo;								
	row9.Preco = out2.Preco;			
	row10 = new row10Struct();
						
	row10.StartRegion_LoopedRegionId = out2.StartRegion_LoopedRegionId;								
	row10.EndRegion_LoopedRegionId = out2.EndRegion_LoopedRegionId;								
	row10.Codigo = out2.Codigo;								
	row10.Preco = out2.Preco;			
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row7HashKey.EndRegion_LoopedRegionId = row9.EndRegion_LoopedRegionId ;
                        		    		
                        		    		row7HashKey.StartRegion_LoopedRegionId = row9.StartRegion_LoopedRegionId ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.EndRegion_LoopedRegionId = '" + row7HashKey.EndRegion_LoopedRegionId + "', row7.StartRegion_LoopedRegionId = '" + row7HashKey.StartRegion_LoopedRegionId + "'");
								} // G 071
...
// # Output table : 'out1'
out1_tmp.RouteId = row7.RouteId ;
out1_tmp.Codigo = row9.Codigo ;
out1_tmp.Preco = row9.Preco ;
out1 = out1_tmp;
}  // closing inner join bracket (2)
// ###############################
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		...
                        		    		row8HashKey.Route_RouteId = out1.RouteId ;
                        		    		
	                        		    	Object exprKeyValue_row8__Type = out1.Codigo ;
	                        		    	if(exprKeyValue_row8__Type == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_3 = true;
	                        		    	} else {
                        		    			row8HashKey.Type = (int)(Integer) exprKeyValue_row8__Type;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_3 || !tHash_Lookup_row8.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row8 != null && tHash_Lookup_row8.getCount(row8HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.Route_RouteId = '" + row8HashKey.Route_RouteId + "', row8.Type = '" + row8HashKey.Type + "'");
								} // G 071
...
updates_tmp.FareId = row8.FareId ;
updates_tmp.Preco = out1.Preco ;
updates = updates_tmp;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_3 ) {
creates_tmp.RouteId = out1.RouteId ;
creates_tmp.Codigo = out1.Codigo ;
creates_tmp.Preco = out1.Preco ;
creates_tmp.FareId = java.util.UUID.randomUUID();
creates = creates_tmp;
...
if(updates != null) { 
	...
	currentComponent="tPostgresqlOutput_2";
        ...
        whetherReject_tPostgresqlOutput_2 = false;
                    pstmt_tPostgresqlOutput_2.setDouble(1, updates.Preco);

                    if(updates.FareId == null) {
pstmt_tPostgresqlOutput_2.setNull(2 + count_tPostgresqlOutput_2, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(2 + count_tPostgresqlOutput_2, updates.FareId);
}
            ...
            try {
                ...
                updatedCount_tPostgresqlOutput_2 = updatedCount_tPostgresqlOutput_2 + pstmt_tPostgresqlOutput_2.executeUpdate();
...
if(creates != null) { 
	...
	currentComponent="tPostgresqlOutput_3";
        ...
        whetherReject_tPostgresqlOutput_3 = false;
                    if(creates.RouteId == null) {
pstmt_tPostgresqlOutput_3.setNull(1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(1, creates.RouteId, java.sql.Types.OTHER);
}

                    pstmt_tPostgresqlOutput_3.setInt(2, creates.Codigo);

                    pstmt_tPostgresqlOutput_3.setDouble(3, creates.Preco);

                    if(creates.FareId == null) {
pstmt_tPostgresqlOutput_3.setNull(4, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(4, creates.FareId, java.sql.Types.OTHER);
}
            ...
            try {
                ...
                insertedCount_tPostgresqlOutput_3 = insertedCount_tPostgresqlOutput_3 + pstmt_tPostgresqlOutput_3.executeUpdate();
 					    ...
 					    boolean forceLooprow11 = false;
 							...
 							row11Struct row11ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		...
                        		    		row11HashKey.EndRegion_LoopedRegionId = row10.StartRegion_LoopedRegionId ;
                        		    		
                        		    		row11HashKey.StartRegion_LoopedRegionId = row10.EndRegion_LoopedRegionId ;
				           		...
				           		if(tHash_Lookup_row11 != null && tHash_Lookup_row11.getCount(row11HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row11' and it contains more one result from keys :  row11.EndRegion_LoopedRegionId = '" + row11HashKey.EndRegion_LoopedRegionId + "', row11.StartRegion_LoopedRegionId = '" + row11HashKey.StartRegion_LoopedRegionId + "'");
								} // G 071
...
copyOfout1_tmp.RouteId = row11.RouteId ;
copyOfout1_tmp.Codigo = row10.Codigo ;
copyOfout1_tmp.Preco = row10.Preco ;
 					    ...
 					    boolean forceLooprow12 = false;
 							...
 							row12Struct row12ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		...
                        		    		row12HashKey.Route_RouteId = copyOfout1.RouteId ;
                        		    		
	                        		    	Object exprKeyValue_row12__Type = copyOfout1.Codigo ;
	                        		    	if(exprKeyValue_row12__Type == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_5 = true;
	                        		    	} else {
                        		    			row12HashKey.Type = (int)(Integer) exprKeyValue_row12__Type;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_5 || !tHash_Lookup_row12.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row12 != null && tHash_Lookup_row12.getCount(row12HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row12' and it contains more one result from keys :  row12.Route_RouteId = '" + row12HashKey.Route_RouteId + "', row12.Type = '" + row12HashKey.Type + "'");
								} // G 071
...
// # Output table : 'copyOfupdates'
copyOfupdates_tmp.FareId = row12.FareId ;
copyOfupdates_tmp.Preco = copyOfout1.Preco ;
copyOfupdates = copyOfupdates_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'copyOfcreates'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
copyOfcreates_tmp.RouteId = copyOfout1.RouteId ;
copyOfcreates_tmp.Codigo = copyOfout1.Codigo ;
copyOfcreates_tmp.Preco = copyOfout1.Preco ;
copyOfcreates_tmp.FareId = java.util.UUID.randomUUID() ;
copyOfcreates = copyOfcreates_tmp;
} // closing filter/reject
// ###############################
 ...
 */
// Start of branch "copyOfupdates"
if(copyOfupdates != null) { 
	...
	currentComponent="tPostgresqlOutput_4";
			...
			//copyOfupdates
				...
				if(execStat){
					runStat.updateStatOnConnection("copyOfupdates"+iterateId,1, 1);
				} 
        ...
        whetherReject_tPostgresqlOutput_4 = false;
                    pstmt_tPostgresqlOutput_4.setDouble(1, copyOfupdates.Preco);

                    if(copyOfupdates.FareId == null) {
pstmt_tPostgresqlOutput_4.setNull(2 + count_tPostgresqlOutput_4, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_4.setObject(2 + count_tPostgresqlOutput_4, copyOfupdates.FareId);
}
            ...
            try {
                ...
                updatedCount_tPostgresqlOutput_4 = updatedCount_tPostgresqlOutput_4 + pstmt_tPostgresqlOutput_4.executeUpdate();
...
} // End of branch "copyOfupdates"




// Start of branch "copyOfcreates"
if(copyOfcreates != null) { 
	...
	currentComponent="tPostgresqlOutput_5";
			...
			//copyOfcreates
				...
				if(execStat){
					runStat.updateStatOnConnection("copyOfcreates"+iterateId,1, 1);
				} 
        ...
        whetherReject_tPostgresqlOutput_5 = false;
                    if(copyOfcreates.RouteId == null) {
pstmt_tPostgresqlOutput_5.setNull(1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_5.setObject(1, copyOfcreates.RouteId, java.sql.Types.OTHER);
}

                    pstmt_tPostgresqlOutput_5.setInt(2, copyOfcreates.Codigo);

                    pstmt_tPostgresqlOutput_5.setDouble(3, copyOfcreates.Preco);

                    if(copyOfcreates.FareId == null) {
pstmt_tPostgresqlOutput_5.setNull(4, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_5.setObject(4, copyOfcreates.FareId, java.sql.Types.OTHER);
}
            ...
            try {
                ...
                insertedCount_tPostgresqlOutput_5 = insertedCount_tPostgresqlOutput_5 + pstmt_tPostgresqlOutput_5.executeUpdate();
 ...
 */
	...
	nb_line_rejected_tPostgresqlOutput_4=nb_line_rejected_tPostgresqlOutput_4 + rejectedCount_tPostgresqlOutput_4;
        ...
        globalMap.put("tPostgresqlOutput_4_NB_LINE_REJECTED", nb_line_rejected_tPostgresqlOutput_4);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("copyOfupdates"+iterateId,2, 0); 
			 	}
			}
 ...
 */
	...
	nb_line_rejected_tPostgresqlOutput_5=nb_line_rejected_tPostgresqlOutput_5 + rejectedCount_tPostgresqlOutput_5;
        ...
        globalMap.put("tPostgresqlOutput_5_NB_LINE_REJECTED", nb_line_rejected_tPostgresqlOutput_5);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("copyOfcreates"+iterateId,2, 0); 
			 	}
			}
...
public static class row14Struct implements routines.system.IPersistableRow<row14Struct> {
    ...
    public String loopKey;
			    ...
			    public Object Route_RouteId;

				public Object getRoute_RouteId () {
					return this.Route_RouteId;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.Route_RouteId == null) ? 0 : this.Route_RouteId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row14Struct other = (row14Struct) obj;
						...
						if (this.Route_RouteId == null) {
							if (other.Route_RouteId != null)
								return false;
						
						} else if (!this.Route_RouteId.equals(other.Route_RouteId))
	...
	public void copyDataTo(row14Struct other) {
		...
		other.Route_RouteId = this.Route_RouteId;
		...
		synchronized(commonByteArrayLock_YETL_Fares) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.Route_RouteId = (Object) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Object
       			    	...
       			    	dos.writeObject(this.Route_RouteId);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("Route_RouteId="+String.valueOf(Route_RouteId));
	    sb.append("]");
    ...
    public int compareTo(row14Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.Route_RouteId, other.Route_RouteId);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tPostgresqlInput_8";
		...
		int tos_count_tPostgresqlInput_8 = 0;
		    ...
		    String dbquery_tPostgresqlInput_8 = "select \"public\".\"Fares\".\"Route_RouteId\"\nfrom \"public\".\"Fares\"\nwhere \"public\".\"Fares\".\"Price\" > 0";
		    ...
		    while (rs_tPostgresqlInput_8.next()) {
		        nb_line_tPostgresqlInput_8++;
							...
							if(colQtyInRs_tPostgresqlInput_8 < 1) {
								row13.Route_RouteId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_8.getObject(1) != null) {
                row13.Route_RouteId = rs_tPostgresqlInput_8.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
operation_finder_tAggregateRow_1.Route_RouteId = row13.Route_RouteId;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.Route_RouteId = operation_finder_tAggregateRow_1.Route_RouteId;
...
String dbschema_tPostgresqlOutput_6 = null;
	dbschema_tPostgresqlOutput_6 = (String)globalMap.get("schema_" + "tPostgresqlConnection_1");
	

String tableName_tPostgresqlOutput_6 = null;
if(dbschema_tPostgresqlOutput_6 == null || dbschema_tPostgresqlOutput_6.trim().length() == 0) {
	tableName_tPostgresqlOutput_6 = "Routes";
} else {
	tableName_tPostgresqlOutput_6 = dbschema_tPostgresqlOutput_6 + "\".\"" + "Routes";
}
...
String dbUser_tPostgresqlOutput_6 = null;
	...
	conn_tPostgresqlOutput_6 = (java.sql.Connection)globalMap.get("conn_tPostgresqlConnection_1");
...
int count_tPostgresqlOutput_6=0;
	    String update_tPostgresqlOutput_6 = "UPDATE \"" + tableName_tPostgresqlOutput_6 + "\" SET \"" + "Active" + "\" = " + "true" + " WHERE \"RouteId\" = ?";
	    java.sql.PreparedStatement pstmt_tPostgresqlOutput_6 = conn_tPostgresqlOutput_6.prepareStatement(update_tPostgresqlOutput_6);
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row14.Route_RouteId = aggregated_row_tAggregateRow_1.Route_RouteId;
 ...
 */
	...
	currentComponent="tPostgresqlOutput_6";
        ...
        whetherReject_tPostgresqlOutput_6 = false;
                    if(row14.Route_RouteId == null) {
pstmt_tPostgresqlOutput_6.setNull(1 + count_tPostgresqlOutput_6, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_6.setObject(1 + count_tPostgresqlOutput_6, row14.Route_RouteId);
}
    		  ...
    		  batchSizeCounter_tPostgresqlOutput_6++;
                ...
                try {
						...
						for(int countEach_tPostgresqlOutput_6: pstmt_tPostgresqlOutput_6.executeBatch()) {
				    		...
				    		updatedCount_tPostgresqlOutput_6 += countSum_tPostgresqlOutput_6;
				    	
            	    	batchSizeCounter_tPostgresqlOutput_6 = 0;
                }catch (java.sql.BatchUpdateException e_tPostgresqlOutput_6){
				    	java.sql.SQLException ne_tPostgresqlOutput_6 = e_tPostgresqlOutput_6.getNextException(),sqle_tPostgresqlOutput_6=null;
				    	String errormessage_tPostgresqlOutput_6;
						if (ne_tPostgresqlOutput_6 != null) {
							// build new exception to provide the original cause
							sqle_tPostgresqlOutput_6 = new java.sql.SQLException(e_tPostgresqlOutput_6.getMessage() + "\ncaused by: " + ne_tPostgresqlOutput_6.getMessage(), ne_tPostgresqlOutput_6.getSQLState(), ne_tPostgresqlOutput_6.getErrorCode(), ne_tPostgresqlOutput_6);
							errormessage_tPostgresqlOutput_6 = sqle_tPostgresqlOutput_6.getMessage();
						}else{
							errormessage_tPostgresqlOutput_6 = e_tPostgresqlOutput_6.getMessage();
						}
				    	
				    	int countSum_tPostgresqlOutput_6 = 0;
						for(int countEach_tPostgresqlOutput_6: e_tPostgresqlOutput_6.getUpdateCounts()) {
							countSum_tPostgresqlOutput_6 += (countEach_tPostgresqlOutput_6 < 0 ? 0 : countEach_tPostgresqlOutput_6);
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tPostgresqlInput_2 - inputs:(after_tFileInputExcel_1) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row5,row6) outputs:(out2)
...
+"dRegions\" where \"public\".\"LoopedRegions\".\"Active\" = true\n;";
		    ...
		    while (rs_tPostgresqlInput_2.next()) {
		        nb_line_tPostgresqlInput_2++;
							...
							if(colQtyInRs_tPostgresqlInput_2 < 1) {
								row5.LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(1) != null) {
                row5.LoopedRegionId = rs_tPostgresqlInput_2.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row5.Name = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_2, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
			...
			//row5
				...
				row5_HashRow.LoopedRegionId = row5.LoopedRegionId;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tPostgresqlInput_3 - inputs:(after_tFileInputExcel_1) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row5,row6) outputs:(out2)
 ...
 */
	...
	currentComponent="tPostgresqlInput_3";
		...
		int tos_count_tPostgresqlInput_3 = 0;
		    ...
		    String dbquery_tPostgresqlInput_3 = "select \"public\".\"LoopedRegions\".\"LoopedRegionId\",\n \"public\".\"LoopedRegions\".\"Name\" \nfrom \"public\".\"Loope"
+"dRegions\" where \"public\".\"LoopedRegions\".\"Active\" = true\n;";
		    ...
		    while (rs_tPostgresqlInput_3.next()) {
		        nb_line_tPostgresqlInput_3++;
							...
							if(colQtyInRs_tPostgresqlInput_3 < 1) {
								row6.LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_3.getObject(1) != null) {
                row6.LoopedRegionId = rs_tPostgresqlInput_3.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row6.Name = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_3, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
			...
			//row6
				...
				row6_HashRow.LoopedRegionId = row6.LoopedRegionId;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
       			    	...
       			    	this.RouteId = (Object) ois.readObject();
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// source node:tPostgresqlInput_4 - inputs:(after_tFileInputExcel_1) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
			   		// linked node: tMap_2 - inputs:(row9,row7) outputs:(out1)
 ...
 */
	...
	currentComponent="tPostgresqlInput_4";
		...
		int tos_count_tPostgresqlInput_4 = 0;
		    ...
		    String dbquery_tPostgresqlInput_4 = "select \"public\".\"Routes\".\"EndRegion_LoopedRegionId\",\"public\".\"Routes\".\"RouteId\",\n \"public\".\"Routes\".\"S"
+"tartRegion_LoopedRegionId\" \nfrom \"public\".\"Routes\"";
		    ...
		    while (rs_tPostgresqlInput_4.next()) {
		        nb_line_tPostgresqlInput_4++;
							...
							if(colQtyInRs_tPostgresqlInput_4 < 1) {
								row7.EndRegion_LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_4.getObject(1) != null) {
                row7.EndRegion_LoopedRegionId = rs_tPostgresqlInput_4.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_4.getObject(2) != null) {
                row7.RouteId = rs_tPostgresqlInput_4.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_4 < 3) {
								row7.StartRegion_LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_4.getObject(3) != null) {
                row7.StartRegion_LoopedRegionId = rs_tPostgresqlInput_4.getObject(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
			...
			//row7
				...
				row7_HashRow.EndRegion_LoopedRegionId = row7.EndRegion_LoopedRegionId;
				
				row7_HashRow.RouteId = row7.RouteId;
				
				row7_HashRow.StartRegion_LoopedRegionId = row7.StartRegion_LoopedRegionId;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row11";
		...
		int tos_count_tAdvancedHash_row11 = 0;
			   		...
			   		// source node:tPostgresqlInput_6 - inputs:(after_tFileInputExcel_1) outputs:(row11,row11) | target node:tAdvancedHash_row11 - inputs:(row11) outputs:()
			   		// linked node: tMap_4 - inputs:(row10,row11) outputs:(copyOfout1)
 ...
 */
	...
	currentComponent="tPostgresqlInput_6";
		...
		int tos_count_tPostgresqlInput_6 = 0;
		    ...
		    String dbquery_tPostgresqlInput_6 = "select \"public\".\"Routes\".\"EndRegion_LoopedRegionId\",\"public\".\"Routes\".\"RouteId\",\n \"public\".\"Routes\".\"S"
+"tartRegion_LoopedRegionId\" \nfrom \"public\".\"Routes\"";
		    ...
		    while (rs_tPostgresqlInput_6.next()) {
		        nb_line_tPostgresqlInput_6++;
							...
							if(colQtyInRs_tPostgresqlInput_6 < 1) {
								row11.EndRegion_LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_6.getObject(1) != null) {
                row11.EndRegion_LoopedRegionId = rs_tPostgresqlInput_6.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_6.getObject(2) != null) {
                row11.RouteId = rs_tPostgresqlInput_6.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_6 < 3) {
								row11.StartRegion_LoopedRegionId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_6.getObject(3) != null) {
                row11.StartRegion_LoopedRegionId = rs_tPostgresqlInput_6.getObject(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row11";
			...
			//row11
				...
				row11_HashRow.EndRegion_LoopedRegionId = row11.EndRegion_LoopedRegionId;
				
				row11_HashRow.RouteId = row11.RouteId;
				
				row11_HashRow.StartRegion_LoopedRegionId = row11.StartRegion_LoopedRegionId;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
       			    	...
       			    	this.FareId = (Object) ois.readObject();
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row12";
		...
		int tos_count_tAdvancedHash_row12 = 0;
			   		...
			   		// source node:tPostgresqlInput_7 - inputs:(after_tFileInputExcel_1) outputs:(row12,row12) | target node:tAdvancedHash_row12 - inputs:(row12) outputs:()
			   		// linked node: tMap_5 - inputs:(copyOfout1,row12) outputs:(copyOfupdates,copyOfcreates)
	...
	currentComponent="tPostgresqlInput_7";
		...
		int tos_count_tPostgresqlInput_7 = 0;
		    ...
		    java.sql.Connection conn_tPostgresqlInput_7 = null;
		        conn_tPostgresqlInput_7 = (java.sql.Connection)globalMap.get("conn_tPostgresqlConnection_1");
		    
			java.sql.Statement stmt_tPostgresqlInput_7 = conn_tPostgresqlInput_7.createStatement();

		    String dbquery_tPostgresqlInput_7 = "select \"public\".\"Fares\".\"FareId\",\"public\".\"Fares\".\"Route_RouteId\",\n \"public\".\"Fares\".\"Type\" \nfrom \"p"
+"ublic\".\"Fares\"";
            ...
            if(rs_tPostgresqlInput_7.getObject(1) != null) {
                row12.FareId = rs_tPostgresqlInput_7.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_7 < 2) {
								row12.Route_RouteId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_7.getObject(2) != null) {
                row12.Route_RouteId = rs_tPostgresqlInput_7.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_7.getObject(3) != null) {
                row12.Type = rs_tPostgresqlInput_7.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row12";
			...
			//row12
				...
				row12_HashRow.FareId = row12.FareId;
				
				row12_HashRow.Route_RouteId = row12.Route_RouteId;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// source node:tPostgresqlInput_5 - inputs:(after_tFileInputExcel_1) outputs:(row8,row8) | target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
			   		// linked node: tMap_3 - inputs:(out1,row8) outputs:(updates,creates)
 ...
 */
	...
	currentComponent="tPostgresqlInput_5";
		...
		int tos_count_tPostgresqlInput_5 = 0;
		    ...
		    String dbquery_tPostgresqlInput_5 = "select \"public\".\"Fares\".\"FareId\",\"public\".\"Fares\".\"Route_RouteId\",\n \"public\".\"Fares\".\"Type\" \nfrom \"p"
+"ublic\".\"Fares\"";
            ...
            if(rs_tPostgresqlInput_5.getObject(1) != null) {
                row8.FareId = rs_tPostgresqlInput_5.getObject(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_5 < 2) {
								row8.Route_RouteId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_5.getObject(2) != null) {
                row8.Route_RouteId = rs_tPostgresqlInput_5.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_5.getObject(3) != null) {
                row8.Type = rs_tPostgresqlInput_5.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
			...
			//row8
				...
				row8_HashRow.FareId = row8.FareId;
				
				row8_HashRow.Route_RouteId = row8.Route_RouteId;
 ...
 */
    ...
    public static void main(String[] args){
        final Fares FaresClass = new Fares();

        int exitCode = FaresClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fares.class.getClassLoader().getResourceAsStream("yetl/fares_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Fares.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fares");
        }
...
/************************************************************************************************
 *     322019 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 de Janeiro de 2019 23:58:21 GMT
 ************************************************************************************************/