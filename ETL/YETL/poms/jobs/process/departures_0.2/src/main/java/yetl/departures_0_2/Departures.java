...
/**
 * Job: Departures Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Departures implements TalendJob {
...
public String getServer(){
	...
	private final String jobName = "Departures";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Departures.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_YETL_Departures = new byte[0];
    static byte[] commonByteArray_YETL_Departures = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.DepartureId == null) ? 0 : this.DepartureId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						} else if (!this.DepartureId.equals(other.DepartureId))
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_YETL_Departures) {

        	try {

        		int length = 0;
		
						this.DepartureId = (Object) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Object
       			    	...
       			    	dos.writeObject(this.DepartureId);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("DepartureId="+String.valueOf(DepartureId));
	    sb.append("]");
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.DepartureId, other.DepartureId);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "Departures";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "Departures";
}
...
int count_tPostgresqlOutput_1=0;
	    String update_tPostgresqlOutput_1 = "UPDATE \"" + tableName_tPostgresqlOutput_1 + "\" SET \"" + "Active" + "\" = " + "false" + " WHERE \"DepartureId\" = ?";
 ...
 */
	...
	currentComponent="tPostgresqlInput_1";
		...
		int tos_count_tPostgresqlInput_1 = 0;
		    ...
		    String dbquery_tPostgresqlInput_1 = "select \"public\".\"Departures\".\"DepartureId\" \nfrom \"public\".\"Departures\"";
		    ...
		    while (rs_tPostgresqlInput_1.next()) {
		        nb_line_tPostgresqlInput_1++;
							...
							if(colQtyInRs_tPostgresqlInput_1 < 1) {
								row1.DepartureId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_1.getObject(1) != null) {
                row1.DepartureId = rs_tPostgresqlInput_1.getObject(1);
            } else {
 ...
 */
	...
	currentComponent="tPostgresqlOutput_1";
        ...
        whetherReject_tPostgresqlOutput_1 = false;
                    if(row1.DepartureId == null) {
pstmt_tPostgresqlOutput_1.setNull(1 + count_tPostgresqlOutput_1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_1.setObject(1 + count_tPostgresqlOutput_1, row1.DepartureId);
}
...
public static class updatesStruct implements routines.system.IPersistableRow<updatesStruct> {
    ...
    public String loopKey;
			    ...
			    public Object DurationModifier;

				public Object getDurationModifier () {
	...
	public void copyDataTo(updatesStruct other) {
		...
		other.DepartureId = this.DepartureId;
	            other.DurationModifier = this.DurationModifier;
		...
		synchronized(commonByteArrayLock_YETL_Departures) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.DurationModifier = (Object) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Object
       			    	...
       			    	dos.writeObject(this.DurationModifier);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("DepartureId="+String.valueOf(DepartureId));
		sb.append(",DurationModifier="+String.valueOf(DurationModifier));
...
public static class createsStruct implements routines.system.IPersistableRow<createsStruct> {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.Num = dis.readInt();
						...
						this.Hora = (Object) dis.readObject();
    ...
    public String toString() {
		...
		sb.append(",Hora="+String.valueOf(Hora));
		sb.append(",DurationModifier="+String.valueOf(DurationModifier));
		sb.append(",Activo="+String.valueOf(Activo));
		sb.append(",DepartureId="+String.valueOf(DepartureId));
	    sb.append("]");
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.Num = dis.readInt();
						...
						this.Modificador = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.Modificador,dos);
    ...
    public String toString() {
		...
		sb.append(",Num="+String.valueOf(Num));
		sb.append(",Hora="+String.valueOf(Hora));
		sb.append(",Modificador="+String.valueOf(Modificador));
		sb.append(",Activo="+String.valueOf(Activo));
	    sb.append("]");
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_YETL_Departures.length) {
				if(length < 1024 && commonByteArray_YETL_Departures.length == 0) {
   					commonByteArray_YETL_Departures = new byte[1024];
				} else {
   					commonByteArray_YETL_Departures = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_YETL_Departures, 0, length);
			strReturn = new String(commonByteArray_YETL_Departures, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		synchronized(commonByteArrayLock_YETL_Departures) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Hora = readDate(dis);
					
						this.Modificador = readInteger(dis);
					
						this.Veiculo = readInteger(dis);
    ...
    public String toString() {
		...
		sb.append(",Hora="+String.valueOf(Hora));
		sb.append(",Modificador="+String.valueOf(Modificador));
		sb.append(",Veiculo="+String.valueOf(Veiculo));
	    sb.append("]");
...
if(dbschema_tPostgresqlOutput_2 == null || dbschema_tPostgresqlOutput_2.trim().length() == 0) {
	tableName_tPostgresqlOutput_2 = "Departures";
} else {
	tableName_tPostgresqlOutput_2 = dbschema_tPostgresqlOutput_2 + "\".\"" + "Departures";
}
...
int count_tPostgresqlOutput_2=0;
	    String update_tPostgresqlOutput_2 = "UPDATE \"" + tableName_tPostgresqlOutput_2 + "\" SET \"DurationModifier\" = ?,\"Active\" = ? WHERE \"DepartureId\" = ?";
...
if(dbschema_tPostgresqlOutput_3 == null || dbschema_tPostgresqlOutput_3.trim().length() == 0) {
	tableName_tPostgresqlOutput_3 = "Departures";
} else {
	tableName_tPostgresqlOutput_3 = dbschema_tPostgresqlOutput_3 + "\".\"" + "Departures";
}
...
int count_tPostgresqlOutput_3=0;
	    String insert_tPostgresqlOutput_3 = "INSERT INTO \"" + tableName_tPostgresqlOutput_3 + "\" (\"Route_RouteId\",\"DayType\",\"Time\",\"DurationModifier\",\"Active\",\"DepartureId\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Partidas", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "Dia";

				row2.Dia = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Dia = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Num";

				row2.Num = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Num = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Hora";
				...
				if(4<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row2.Hora = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "HH:mm");
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.Hora = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Modificador";

				row2.Modificador = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Modificador = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Veiculo";

				row2.Veiculo = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Veiculo = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row2 != null) { 
    ...
    if ( row2.Dia != null ) {
    globalMap.put("DIA", row2.Dia);
    row3.Dia = row2.Dia;
}
else {
    row3.Dia = (String)globalMap.get("DIA");
}

if ( row2.Num != null ) {
    globalMap.put("NUM", row2.Num);
    row3.Num = row2.Num;
}
else {
    row3.Num = (Integer)globalMap.get("NUM");
}
...
row3.Hora = row2.Hora;
row3.Modificador = row2.Modificador;
row3.Veiculo = row2.Veiculo;
 ...
 */
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
	        ope_tFilterRow_1.matches((row3.Hora != null)
	                       , "Hora!=null failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row4 == null){ 
               ...
               row4.Hora = row3.Hora;
               row4.Modificador = row3.Modificador;
               row4.Veiculo = row3.Veiculo;    
...
// # Output table : 'out1'
out1_tmp.Num = row4.Num ;
out1_tmp.Origem = row4.Origem ;
out1_tmp.Destino = row4.Destino ;
out1_tmp.Hora = new org.postgresql.util.PGInterval(0, 0, 0, row4.Hora.getHours(), row4.Hora.getMinutes(), 0);
out1_tmp.Modificador = row4.Modificador ;
out1 = out1_tmp;
// ###############################
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		row7HashKey.EndRegion_LoopedRegionId = row6.LoopedRegionId ;
                        		    		
                        		    		row7HashKey.StartRegion_LoopedRegionId = row5.LoopedRegionId ;
...
// # Output table : 'out2'
out2_tmp.RouteId = row7.RouteId ;
out2_tmp.Num = out1.Num ;
out2_tmp.Hora = out1.Hora ;
out2_tmp.Modificador = out1.Modificador ;
out2_tmp.Activo = true;
out2 = out2_tmp;
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row8__DayType = out2.Num ;
	                        		    	if(exprKeyValue_row8__DayType == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_3 = true;
	                        		    	} else {
                        		    			row8HashKey.DayType = (int)(Integer) exprKeyValue_row8__DayType;
                        		    		}
                        		    		
                        		    		row8HashKey.Route_RouteId = out2.RouteId ;
                        		    		
                        		    		row8HashKey.Time = out2.Hora ;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_3 || !tHash_Lookup_row8.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row8 != null && tHash_Lookup_row8.getCount(row8HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.DayType = '" + row8HashKey.DayType + "', row8.Route_RouteId = '" + row8HashKey.Route_RouteId + "', row8.Time = '" + row8HashKey.Time + "'");
								} // G 071
...
updates_tmp.DepartureId = row8.DepartureId ;
updates_tmp.DurationModifier = new org.postgresql.util.PGInterval ("" + out2.Modificador + " minutes") ;
updates_tmp.Activo = out2.Activo ;
updates = updates_tmp;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_3 ) {
creates_tmp.RouteId = out2.RouteId ;
creates_tmp.Num = out2.Num ;
creates_tmp.Hora = out2.Hora;
creates_tmp.DurationModifier = new org.postgresql.util.PGInterval ("" + out2.Modificador + " minutes") ;
creates_tmp.Activo = out2.Activo ;
creates_tmp.DepartureId = java.util.UUID.randomUUID();
creates = creates_tmp;
...
if(updates != null) { 
	...
	currentComponent="tPostgresqlOutput_2";
        ...
        whetherReject_tPostgresqlOutput_2 = false;
                    if(updates.DurationModifier == null) {
pstmt_tPostgresqlOutput_2.setNull(1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(1, updates.DurationModifier);
}

                    pstmt_tPostgresqlOutput_2.setBoolean(2, updates.Activo);

                    if(updates.DepartureId == null) {
pstmt_tPostgresqlOutput_2.setNull(3 + count_tPostgresqlOutput_2, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(3 + count_tPostgresqlOutput_2, updates.DepartureId);
}
...
pstmt_tPostgresqlOutput_3.setNull(1, java.sql.Types.OTHER);
                    ...
                    pstmt_tPostgresqlOutput_3.setInt(2, creates.Num);

                    if(creates.Hora == null) {
pstmt_tPostgresqlOutput_3.setNull(3, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(3, creates.Hora);
}

                    if(creates.DurationModifier == null) {
pstmt_tPostgresqlOutput_3.setNull(4, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(4, creates.DurationModifier);
}

                    pstmt_tPostgresqlOutput_3.setBoolean(5, creates.Activo);

                    if(creates.DepartureId == null) {
pstmt_tPostgresqlOutput_3.setNull(6, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(6, creates.DepartureId, java.sql.Types.OTHER);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(out1,row5,row6,row7) outputs:(out2)
...
public static class row8Struct implements routines.system.IPersistableComparableLookupRow<row8Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.DayType;
		...
		synchronized(commonByteArrayLock_YETL_Departures) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.DayType = dis.readInt();
					
						this.Route_RouteId = (Object) dis.readObject();
					
						this.Time = (Object) dis.readObject();
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
       			    	...
       			    	this.DepartureId = (Object) ois.readObject();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
       			    	...
       			    	oos.writeObject(this.DepartureId);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("DayType="+String.valueOf(DayType));
		sb.append(",DepartureId="+String.valueOf(DepartureId));
    ...
    public int compareTo(row8Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.DayType, other.DayType);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(out2,row8) outputs:(updates,creates)
 ...
 */
	...
	currentComponent="tPostgresqlInput_5";
		...
		int tos_count_tPostgresqlInput_5 = 0;
		    ...
		    String dbquery_tPostgresqlInput_5 = "select \"public\".\"Departures\".\"DayType\",\"public\".\"Departures\".\"DepartureId\",\n \"public\".\"Departures\".\"Ro"
+"ute_RouteId\",\"public\".\"Departures\".\"Time\" \nfrom \"public\".\"Departures\"";
            ...
            if(rs_tPostgresqlInput_5.getObject(1) != null) {
                row8.DayType = rs_tPostgresqlInput_5.getInt(1);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tPostgresqlInput_5 < 2) {
								row8.DepartureId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_5.getObject(2) != null) {
                row8.DepartureId = rs_tPostgresqlInput_5.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_5.getObject(3) != null) {
                row8.Route_RouteId = rs_tPostgresqlInput_5.getObject(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tPostgresqlInput_5.getObject(4) != null) {
                row8.Time = rs_tPostgresqlInput_5.getObject(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
			...
			//row8
				...
				row8_HashRow.DayType = row8.DayType;
				
				row8_HashRow.DepartureId = row8.DepartureId;
				
				row8_HashRow.Route_RouteId = row8.Route_RouteId;
				
				row8_HashRow.Time = row8.Time;
 ...
 */
    ...
    public static void main(String[] args){
        final Departures DeparturesClass = new Departures();

        int exitCode = DeparturesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Departures.class.getClassLoader().getResourceAsStream("yetl/departures_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Departures.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Departures");
        }
...
/************************************************************************************************
 *     217755 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 de Janeiro de 2019 23:58:22 GMT
 ************************************************************************************************/