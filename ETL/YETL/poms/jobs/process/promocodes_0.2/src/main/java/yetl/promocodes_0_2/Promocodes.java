...
/**
 * Job: Promocodes Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Promocodes implements TalendJob {
...
public String getServer(){
	...
	private final String jobName = "Promocodes";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Promocodes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_YETL_Promocodes = new byte[0];
    static byte[] commonByteArray_YETL_Promocodes = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.PromocodeId == null) ? 0 : this.PromocodeId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						} else if (!this.PromocodeId.equals(other.PromocodeId))
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_YETL_Promocodes) {

        	try {

        		int length = 0;
		
						this.PromocodeId = (Object) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Object
       			    	...
       			    	dos.writeObject(this.PromocodeId);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("PromocodeId="+String.valueOf(PromocodeId));
	    sb.append("]");
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.PromocodeId, other.PromocodeId);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tPostgresqlOutput_3 == null || dbschema_tPostgresqlOutput_3.trim().length() == 0) {
	tableName_tPostgresqlOutput_3 = "Promocodes";
} else {
	tableName_tPostgresqlOutput_3 = dbschema_tPostgresqlOutput_3 + "\".\"" + "Promocodes";
}
...
int count_tPostgresqlOutput_3=0;
	    String update_tPostgresqlOutput_3 = "UPDATE \"" + tableName_tPostgresqlOutput_3 + "\" SET \"" + "Active" + "\" = " + "false" + " WHERE \"PromocodeId\" = ?";
 ...
 */
	...
	currentComponent="tPostgresqlInput_2";
		...
		int tos_count_tPostgresqlInput_2 = 0;
		    ...
		    String dbquery_tPostgresqlInput_2 = "select \"public\".\"Promocodes\".\"PromocodeId\" \nfrom \"public\".\"Promocodes\"";
		    ...
		    while (rs_tPostgresqlInput_2.next()) {
		        nb_line_tPostgresqlInput_2++;
							...
							if(colQtyInRs_tPostgresqlInput_2 < 1) {
								row1.PromocodeId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_2.getObject(1) != null) {
                row1.PromocodeId = rs_tPostgresqlInput_2.getObject(1);
            } else {
 ...
 */
	...
	currentComponent="tPostgresqlOutput_3";
        ...
        whetherReject_tPostgresqlOutput_3 = false;
                    if(row1.PromocodeId == null) {
pstmt_tPostgresqlOutput_3.setNull(1 + count_tPostgresqlOutput_3, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_3.setObject(1 + count_tPostgresqlOutput_3, row1.PromocodeId);
}
...
public static class updatesStruct implements routines.system.IPersistableRow<updatesStruct> {
    ...
    public String toString() {
		...
		sb.append(",Tarifa="+String.valueOf(Tarifa));
		sb.append(",PromocodeId="+String.valueOf(PromocodeId));
...
public static class createsStruct implements routines.system.IPersistableRow<createsStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_YETL_Promocodes.length) {
				if(length < 1024 && commonByteArray_YETL_Promocodes.length == 0) {
   					commonByteArray_YETL_Promocodes = new byte[1024];
				} else {
   					commonByteArray_YETL_Promocodes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_YETL_Promocodes, 0, length);
			strReturn = new String(commonByteArray_YETL_Promocodes, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "Promocodes";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "Promocodes";
}
...
int count_tPostgresqlOutput_1=0;
	    String update_tPostgresqlOutput_1 = "UPDATE \"" + tableName_tPostgresqlOutput_1 + "\" SET \"StartDate\" = ?,\"EndDate\" = ?,\"FareType\" = ?,\"Active\" = ? WHERE \"PromocodeId\" = ?";
...
if(dbschema_tPostgresqlOutput_2 == null || dbschema_tPostgresqlOutput_2.trim().length() == 0) {
	tableName_tPostgresqlOutput_2 = "Promocodes";
} else {
	tableName_tPostgresqlOutput_2 = dbschema_tPostgresqlOutput_2 + "\".\"" + "Promocodes";
}
...
int count_tPostgresqlOutput_2=0;
	    String insert_tPostgresqlOutput_2 = "INSERT INTO \"" + tableName_tPostgresqlOutput_2 + "\" (\"Code\",\"StartDate\",\"EndDate\",\"FareType\",\"PromocodeId\",\"Active\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Promocodes", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row2.Codigo = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row2.Codigo = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Inicio";
				...
				if(1<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row2.Inicio = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.Inicio = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Fim";

				if(2<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row2.Fim = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.Fim = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row2.Tarifa = ParserUtils.parseTo_int(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Tarifa = 0;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
updates_tmp.Inicio = row2.Inicio ;
updates_tmp.Fim = row2.Fim ;
updates_tmp.Tarifa = row2.Tarifa ;
updates_tmp.PromocodeId = row4.PromocodeId ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
creates_tmp.Codigo = row2.Codigo ;
creates_tmp.Inicio = row2.Inicio ;
creates_tmp.Fim = row2.Fim ;
creates_tmp.Tarifa = row2.Tarifa ;
creates_tmp.PromocodeId = java.util.UUID.randomUUID();
...
if(updates != null) { 
	...
	currentComponent="tPostgresqlOutput_1";
        ...
        whetherReject_tPostgresqlOutput_1 = false;
                    if(updates.Inicio != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(1, new java.sql.Timestamp(updates.Inicio.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(updates.Fim != null) {
pstmt_tPostgresqlOutput_1.setTimestamp(2, new java.sql.Timestamp(updates.Fim.getTime()));
} else {
pstmt_tPostgresqlOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
}

                    pstmt_tPostgresqlOutput_1.setInt(3, updates.Tarifa);

                    pstmt_tPostgresqlOutput_1.setBoolean(4, updates.Activo);

                    if(updates.PromocodeId == null) {
pstmt_tPostgresqlOutput_1.setNull(5 + count_tPostgresqlOutput_1, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_1.setObject(5 + count_tPostgresqlOutput_1, updates.PromocodeId);
}
...
if(creates != null) { 
	...
	currentComponent="tPostgresqlOutput_2";
        ...
        whetherReject_tPostgresqlOutput_2 = false;
                    if(creates.Codigo == null) {
pstmt_tPostgresqlOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tPostgresqlOutput_2.setString(1, creates.Codigo);
}

                    if(creates.Inicio != null) {
pstmt_tPostgresqlOutput_2.setTimestamp(2, new java.sql.Timestamp(creates.Inicio.getTime()));
} else {
pstmt_tPostgresqlOutput_2.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(creates.Fim != null) {
pstmt_tPostgresqlOutput_2.setTimestamp(3, new java.sql.Timestamp(creates.Fim.getTime()));
} else {
pstmt_tPostgresqlOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                    pstmt_tPostgresqlOutput_2.setInt(4, creates.Tarifa);

                    if(creates.PromocodeId == null) {
pstmt_tPostgresqlOutput_2.setNull(5, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(5, creates.PromocodeId, java.sql.Types.OTHER);
}

                    pstmt_tPostgresqlOutput_2.setBoolean(6, creates.Activo);
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
       			    	...
       			    	this.PromocodeId = (Object) ois.readObject();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
       			    	...
       			    	oos.writeObject(this.PromocodeId);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row2,row4) outputs:(updates,creates)
 ...
 */
	...
	currentComponent="tPostgresqlInput_1";
		...
		int tos_count_tPostgresqlInput_1 = 0;
		    ...
		    String dbquery_tPostgresqlInput_1 = "select \"public\".\"Promocodes\".\"Code\",\"public\".\"Promocodes\".\"PromocodeId\" \nfrom \"public\".\"Promocodes\"";
        	...
        	row4.Code = routines.system.JDBCUtil.getString(rs_tPostgresqlInput_1, 1, false);
		                    }
							if(colQtyInRs_tPostgresqlInput_1 < 2) {
								row4.PromocodeId = null;
							} else {
		                          
            if(rs_tPostgresqlInput_1.getObject(2) != null) {
                row4.PromocodeId = rs_tPostgresqlInput_1.getObject(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
			...
			//row4
				...
				row4_HashRow.PromocodeId = row4.PromocodeId;
 ...
 */
    ...
    public static void main(String[] args){
        final Promocodes PromocodesClass = new Promocodes();

        int exitCode = PromocodesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Promocodes.class.getClassLoader().getResourceAsStream("yetl/promocodes_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Promocodes.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Promocodes");
        }
...
/************************************************************************************************
 *     128270 characters generated by Talend Open Studio for Data Integration 
