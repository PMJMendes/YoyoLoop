...
/**
 * Job: AccessPoints Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class AccessPoints implements TalendJob {
...
public String getServer(){
	...
	private final String jobName = "AccessPoints";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(AccessPoints.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class after_tFileInputExcel_1Struct implements routines.system.IPersistableRow<after_tFileInputExcel_1Struct> {
	...
	public void copyDataTo(after_tFileInputExcel_1Struct other) {
		...
		other.Nome = this.Nome;
	            ...
	            other.Default = this.Default;
	            other.GoogleLocation = this.GoogleLocation;
	            other.Modificador = this.Modificador;
...
if(dbschema_tPostgresqlOutput_2 == null || dbschema_tPostgresqlOutput_2.trim().length() == 0) {
	tableName_tPostgresqlOutput_2 = "AccessPoints";
} else {
	tableName_tPostgresqlOutput_2 = dbschema_tPostgresqlOutput_2 + "\".\"" + "AccessPoints";
}
...
int count_tPostgresqlOutput_2=0;
	    String update_tPostgresqlOutput_2 = "UPDATE \"" + tableName_tPostgresqlOutput_2 + "\" SET \"Default\" = ?,\"GoogleLocation\" = ?,\"DurationModifier\" = ?,\"Active\" = ? WHERE \"AccessPointId\" = ?";
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	tableName_tPostgresqlOutput_1 = "AccessPoints";
} else {
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "AccessPoints";
}
...
int count_tPostgresqlOutput_1=0;
	    String insert_tPostgresqlOutput_1 = "INSERT INTO \"" + tableName_tPostgresqlOutput_1 + "\" (\"AccessPointId\",\"Name\",\"Default\",\"GoogleLocation\",\"DurationModifier\",\"Region_LoopedRegionId\",\"Active\") VALUES (?,?,?,?,?,?,?)";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row2.Modificador = ParserUtils.parseTo_int(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row2.Modificador = 0;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
out1_tmp.Modificador = row2.Modificador ;
...
updates_tmp.DurationModifier = new org.postgresql.util.PGInterval ("" + out1.Modificador + " minutes");
...
creates_tmp.DurationModifier = new org.postgresql.util.PGInterval ("" + out1.Modificador + " minutes");
...
} else {pstmt_tPostgresqlOutput_2.setObject(3, updates.DurationModifier);
}

                    pstmt_tPostgresqlOutput_2.setBoolean(4, updates.Activo);

                    if(updates.AccessPointId == null) {
pstmt_tPostgresqlOutput_2.setNull(5 + count_tPostgresqlOutput_2, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_2.setObject(5 + count_tPostgresqlOutput_2, updates.AccessPointId);
}
...
} else {pstmt_tPostgresqlOutput_1.setObject(1, creates.AccessPointId, java.sql.Types.OTHER);
}
...
} else {pstmt_tPostgresqlOutput_1.setObject(5, creates.DurationModifier);
}

                    if(creates.LoopedRegionId == null) {
pstmt_tPostgresqlOutput_1.setNull(6, java.sql.Types.OTHER);
} else {pstmt_tPostgresqlOutput_1.setObject(6, creates.LoopedRegionId, java.sql.Types.OTHER);
}

                    pstmt_tPostgresqlOutput_1.setBoolean(7, creates.Activo);
 ...
 */
    ...
    public static void main(String[] args){
        final AccessPoints AccessPointsClass = new AccessPoints();

        int exitCode = AccessPointsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = AccessPoints.class.getClassLoader().getResourceAsStream("yetl/accesspoints_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AccessPoints.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AccessPoints");
        }
...
/************************************************************************************************
 *     157629 characters generated by Talend Open Studio for Data Integration 
