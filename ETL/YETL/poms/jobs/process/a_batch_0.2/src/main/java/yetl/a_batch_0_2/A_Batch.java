...
/**
 * Job: A_Batch Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class A_Batch implements TalendJob {
	...
	private final String jobName = "A_Batch";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(A_Batch.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_1.add("--context=Local");
				...
				paraList_tRunJob_1.add("--context_type " + "Database" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("ExcelPath", context.ExcelPath);
				paraList_tRunJob_1.add("--context_type " + "ExcelPath" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("Login", context.Login);
				paraList_tRunJob_1.add("--context_type " + "Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("Password", context.Password);
				paraList_tRunJob_1.add("--context_type " + "Password" + "="
						+ "id_Password");

				parentContextMap_tRunJob_1.put("Port", context.Port);
				paraList_tRunJob_1.add("--context_type " + "Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("Schema", context.Schema);
				paraList_tRunJob_1.add("--context_type " + "Schema" + "="
						+ "id_String");

				parentContextMap_tRunJob_1.put("Server", context.Server);
				paraList_tRunJob_1.add("--context_type " + "Server" + "="
						+ "id_String");
				...
				yetl.loopedregions_0_2.LoopedRegions childJob_tRunJob_1 = new yetl.loopedregions_0_2.LoopedRegions();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_2.add("--context=Local");
				...
				paraList_tRunJob_2.add("--context_type " + "Database" + "="
						+ "id_String");

				parentContextMap_tRunJob_2.put("ExcelPath", context.ExcelPath);
				paraList_tRunJob_2.add("--context_type " + "ExcelPath" + "="
						+ "id_String");

				parentContextMap_tRunJob_2.put("Login", context.Login);
				paraList_tRunJob_2.add("--context_type " + "Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_2.put("Password", context.Password);
				paraList_tRunJob_2.add("--context_type " + "Password" + "="
						+ "id_Password");

				parentContextMap_tRunJob_2.put("Port", context.Port);
				paraList_tRunJob_2.add("--context_type " + "Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_2.put("Schema", context.Schema);
				paraList_tRunJob_2.add("--context_type " + "Schema" + "="
						+ "id_String");

				parentContextMap_tRunJob_2.put("Server", context.Server);
				paraList_tRunJob_2.add("--context_type " + "Server" + "="
						+ "id_String");
				...
				yetl.accesspoints_0_2.AccessPoints childJob_tRunJob_2 = new yetl.accesspoints_0_2.AccessPoints();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_3.add("--context=Local");
				...
				paraList_tRunJob_3.add("--context_type " + "Database" + "="
						+ "id_String");

				parentContextMap_tRunJob_3.put("ExcelPath", context.ExcelPath);
				paraList_tRunJob_3.add("--context_type " + "ExcelPath" + "="
						+ "id_String");

				parentContextMap_tRunJob_3.put("Login", context.Login);
				paraList_tRunJob_3.add("--context_type " + "Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_3.put("Password", context.Password);
				paraList_tRunJob_3.add("--context_type " + "Password" + "="
						+ "id_Password");

				parentContextMap_tRunJob_3.put("Port", context.Port);
				paraList_tRunJob_3.add("--context_type " + "Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_3.put("Schema", context.Schema);
				paraList_tRunJob_3.add("--context_type " + "Schema" + "="
						+ "id_String");

				parentContextMap_tRunJob_3.put("Server", context.Server);
				paraList_tRunJob_3.add("--context_type " + "Server" + "="
						+ "id_String");
				...
				yetl.routes_0_2.Routes childJob_tRunJob_3 = new yetl.routes_0_2.Routes();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_4.add("--context=Local");
				...
				paraList_tRunJob_4.add("--context_type " + "Database" + "="
						+ "id_String");

				parentContextMap_tRunJob_4.put("ExcelPath", context.ExcelPath);
				paraList_tRunJob_4.add("--context_type " + "ExcelPath" + "="
						+ "id_String");

				parentContextMap_tRunJob_4.put("Login", context.Login);
				paraList_tRunJob_4.add("--context_type " + "Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_4.put("Password", context.Password);
				paraList_tRunJob_4.add("--context_type " + "Password" + "="
						+ "id_Password");

				parentContextMap_tRunJob_4.put("Port", context.Port);
				paraList_tRunJob_4.add("--context_type " + "Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_4.put("Schema", context.Schema);
				paraList_tRunJob_4.add("--context_type " + "Schema" + "="
						+ "id_String");

				parentContextMap_tRunJob_4.put("Server", context.Server);
				paraList_tRunJob_4.add("--context_type " + "Server" + "="
						+ "id_String");
				...
				yetl.fares_0_2.Fares childJob_tRunJob_4 = new yetl.fares_0_2.Fares();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_6.add("--context=Local");
				...
				paraList_tRunJob_6.add("--context_type " + "Database" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("ExcelPath", context.ExcelPath);
				paraList_tRunJob_6.add("--context_type " + "ExcelPath" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("Login", context.Login);
				paraList_tRunJob_6.add("--context_type " + "Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("Password", context.Password);
				paraList_tRunJob_6.add("--context_type " + "Password" + "="
						+ "id_Password");

				parentContextMap_tRunJob_6.put("Port", context.Port);
				paraList_tRunJob_6.add("--context_type " + "Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("Schema", context.Schema);
				paraList_tRunJob_6.add("--context_type " + "Schema" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("Server", context.Server);
				paraList_tRunJob_6.add("--context_type " + "Server" + "="
						+ "id_String");
				...
				yetl.departures_0_2.Departures childJob_tRunJob_6 = new yetl.departures_0_2.Departures();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_5.add("--context=Local");
				...
				paraList_tRunJob_5.add("--context_type " + "Database" + "="
						+ "id_String");

				parentContextMap_tRunJob_5.put("ExcelPath", context.ExcelPath);
				paraList_tRunJob_5.add("--context_type " + "ExcelPath" + "="
						+ "id_String");

				parentContextMap_tRunJob_5.put("Login", context.Login);
				paraList_tRunJob_5.add("--context_type " + "Login" + "="
						+ "id_String");

				parentContextMap_tRunJob_5.put("Password", context.Password);
				paraList_tRunJob_5.add("--context_type " + "Password" + "="
						+ "id_Password");

				parentContextMap_tRunJob_5.put("Port", context.Port);
				paraList_tRunJob_5.add("--context_type " + "Port" + "="
						+ "id_String");

				parentContextMap_tRunJob_5.put("Schema", context.Schema);
				paraList_tRunJob_5.add("--context_type " + "Schema" + "="
						+ "id_String");

				parentContextMap_tRunJob_5.put("Server", context.Server);
				paraList_tRunJob_5.add("--context_type " + "Server" + "="
						+ "id_String");
				...
				yetl.promocodes_0_2.Promocodes childJob_tRunJob_5 = new yetl.promocodes_0_2.Promocodes();
				// pass DataSources
	...
	public static void main(String[] args) {
		final A_Batch A_BatchClass = new A_Batch();

		int exitCode = A_BatchClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = A_Batch.class.getClassLoader()
					.getResourceAsStream(
							"yetl/a_batch_0_2/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = A_Batch.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : A_Batch");
		}
...
/************************************************************************************************
 * 73431 characters generated by Talend Open Studio for Data Integration on the
 * 3 de Janeiro de 2019 23:58:23 GMT
 ************************************************************************************************/
